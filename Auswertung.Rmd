...
```{r}
TPBsubset <- data[,c("ATTsum", "SNsum", "PBCsum","Condition")]
data_determinants <- reshape2::melt(TPBsubset,id = "Condition")
data_determinants$Determinants <- factor(data_determinants$variable, levels = c("ATTsum","SNsum","PBCsum"),
labels = c("Attitudes", "Social norms", "Perceived behavior control")
)
