...
table1(~ GENDER_GROUP + ALTER + EDUCATION_GROUP + COUNTRY_GROUP + BDB_GROUP + BDO_GROUP | Condition, data=MA_data_tabele, overall=c(left="Total"), caption=caption)

table1(~ GENDER_GROUP + ALTER + EDUCATION_GROUP + BDB_GROUP + BDO_GROUP | AGE_GROUP, data=MA_data_tabele, overall=c(left="Total"), caption=caption)
#footnote=footnote)
```
...
cor.test(MA_data$ALTER,MA_data$INTENTION_SUM)
cor.test(MA_data$AGE_GROUP_MEDIATION,MA_data$INTENTION_SUM)
```
...
process(data = MA_data, model=14, x= "AGE_GROUP_MEDIATION", y="INTENTION_SUM", m="INTEGRATED_REGULATION_SUM", w="c_0001",seed = 654321)

process(data = MA_data, model=14, x= "AGE_GROUP_MEDIATION", y="INTENTION_SUM", m="INTRINSIC_REGULATION_SUM", w="c_0001",seed = 654321)
