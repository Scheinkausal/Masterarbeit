...
```
```{r}
plot(MA_data$AMOTIVATION_SUM,MA_data$INTENTION_SUM)
M_Amotivation <- lm(INTENTION_SUM ~ AGE_GROUP_MEDIATION + AMOTIVATION_SUM ,  data = MA_data)
plot(M_Amotivation, 2)
plot(M_Amotivation, 1)
vif(M_Amotivation)
#VIF < 10 alright
plot(M_Amotivation, 4)

plot(MA_data$EXTERNAL_REGULATION_SUM,MA_data$INTENTION_SUM)
M_EXTERNAL_REGULATION_SUM <- lm(INTENTION_SUM ~ AGE_GROUP_MEDIATION + EXTERNAL_REGULATION_SUM ,  data = MA_data)
plot(M_EXTERNAL_REGULATION_SUM, 2)
plot(M_EXTERNAL_REGULATION_SUM, 1)
vif(M_EXTERNAL_REGULATION_SUM)
#VIF < 10 alright
plot(M_EXTERNAL_REGULATION_SUM, 4)

plot(MA_data$IDENTIFIED_REGUALTION_SUM,MA_data$INTENTION_SUM)
M_IDENTIFIED_REGUALTION_SUM <- lm(INTENTION_SUM ~ AGE_GROUP_MEDIATION + IDENTIFIED_REGUALTION_SUM ,  data = MA_data)
plot(M_IDENTIFIED_REGUALTION_SUM, 2)
plot(M_IDENTIFIED_REGUALTION_SUM, 1)
vif(M_IDENTIFIED_REGUALTION_SUM)
#VIF < 10 alright
plot(M_IDENTIFIED_REGUALTION_SUM, 4)

plot(MA_data$INTEGRATED_REGULATION_SUM,MA_data$INTENTION_SUM)
M_INTEGRATED_REGULATION_SUM <- lm(INTENTION_SUM ~ AGE_GROUP_MEDIATION + INTEGRATED_REGULATION_SUM ,  data = MA_data)
plot(M_INTEGRATED_REGULATION_SUM, 2)
plot(M_INTEGRATED_REGULATION_SUM, 1)
vif(M_INTEGRATED_REGULATION_SUM)
#VIF < 10 alright
plot(M_INTEGRATED_REGULATION_SUM, 4)

plot(MA_data$INTRINSIC_REGULATION_SUM,MA_data$INTENTION_SUM)
M_INTRINSIC_REGULATION_SUM <- lm(INTENTION_SUM ~ AGE_GROUP_MEDIATION + INTRINSIC_REGULATION_SUM ,  data = MA_data)
plot(M_INTRINSIC_REGULATION_SUM, 2)
plot(M_INTRINSIC_REGULATION_SUM, 1)
vif(M_INTRINSIC_REGULATION_SUM)
#VIF < 10 alright
plot(M_INTRINSIC_REGULATION_SUM, 4)
